...
// .next/server/edge/chunks/_b51dccfa._.js
var require_b51dccfa = __commonJS({
  ".next/server/edge/chunks/_b51dccfa._.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/_b51dccfa._.js", 38022, (e, a, i) => {
      self._ENTRIES ||= {};
      let o = Promise.resolve().then(() => e.i(42738));
      o.catch(() => {
      }), self._ENTRIES.middleware_middleware = new Proxy(o, { get(e2, a2) {
        if ("then" === a2) return (a3, i3) => e2.then(a3, i3);
        let i2 = (...i3) => e2.then((e3) => (0, e3[a2])(...i3));
        return i2.then = (i3, o2) => e2.then((e3) => e3[a2]).then(i3, o2), i2;
      } });
    }, 50929, (e) => {
      e.v({ HomePage: { title: "Welcome to Daniel Palacios", description: "Portfolio and Personal Site" }, Metadata: { title: "Daniel Palacios | Full-Stack Software Engineer & UX/UI Designer", description: "Daniel Palacios is a bilingual Full-Stack Engineer who builds fast, scalable systems from UX to production. He has delivered measurable impact such as 50% faster load times and reducing project delivery from 6 to 3 months\u2014by building across frontend, backend, and modern development workflows.", keywords: "Daniel Palacios, Full-Stack Engineer, Software Engineer, UX/UI Designer, React, Next.js, Portfolio, Web Development, Frontend, Backend" }, Navigation: { home: "Home", work: "Work", about: "About", contact: "Contact" }, Hero: { name: "<daniel>Daniel</daniel> <ricardo>Ricardo</ricardo> Palacios Diego", daniel_caption: "My grandpa Daniel is known for his charisma, love for helping, and will always greet you with warmth and a big smile (and a piece of wisdom).", ricardo_caption: "My grandfather Ricardo has been one of the boldest, hardest working people I\u2019ve met in my life. RIP 1952-2021\u{1F54A}\uFE0F", role: "Full-Stack Software Engineer and UX/UI Designer", quote: "My purpose is to transform the world through education and technology.", bio: "I am a bilingual Full-Stack Engineer who builds fast, scalable systems from UX to production. I've delivered measurable impact such as 50% faster load times and reducing project delivery from 6 to 3 months\u2014by building across frontend, backend, and modern development workflows. I am known for my product ownership, clear communication, leadership, and problem-solving in complex domains, always striving for excellence.\n\nI am passionate about creating innovative, disruptive technology and the intersection of Human-Computer Interaction (HCI), AR/VR, and Applied AI.", downloadCv: "Download CV", workTogether: "Let's get in touch" }, Footer: { rights: "All rights reserved" }, TechStack: { title: "Tech Stack", design: "Design", "web-ui": "Web UI", backend: "Backend", data: "Data", infrastructure_tools: "Infrastructure & Tools" }, Education: { title: "Education", eafit: { title: "Computer Science Major with Minor in Software Development", scholarship: "Recipient of the fully funded Generaci\xF3n E Scholarship for outstanding performance in a national standardized exam", optika: "Award winning project <optika>Optika</optika>", representative: "Computer science student representative", afroeafit: "Founder of EAFIT Black collective AFROEAFIT", gpa: "4.4/5 GPA" }, certs: { mckinsey: { title: "McKinsey & Company", description: "Communication for impact, Structured problem solving, Adaptability and resilience and more." }, alberta: { title: "University of Alberta", description: "Design Patterns, SOA, Architectural Diagrams and Trade-offs" }, learnquest: { title: "LearnQuest", description: "Backend Development With Spring Boot" } }, readings: { content: "Most of my learning is done by reading, it allows me to engage in a deeper relationship with the information in trying to grasp. For technical books I usually reach for O'Reilly Media.", cta: "Here there is a list of books I\u2019ve studied and constantly find myself going back to.", imageCaption: "For my lifelong learning I pick one technical book and a non-technical book to study, sometimes I will pick a paper/article of interest to read." } }, Work: { job_experience: { title: "Job Experience", swipe_sign: "Swipe to explore the timeline", experiences: { eafit: { title: "EAFIT", role: "Capstone 1 Teaching Assistant", date_range: "Jun 2024 - Ene 2023", activities: ["Mentored 200+ students on full stack development"] }, cadena: { title: "Cadena", role: "Tech Intern", date_range: "Dec 2024 - Jun 2024", activities: ["Developed a no code tool for building HTML templates and dynamic charts using React, Redux and .NET, cutting HTML templates development time.", "Embedded a variable manager for inserting value placeholders in templates to create multiple HTML pages with different data.", "Optimized backend and frontend API calls, improving template loading times by 50%.", "Reduced project duration from 6 to 3 months"] }, cocomasur: { date_range: "Dec 2025 - Sep 2025", title: "Cocomasur", role: "Software Engineer", activities: ["Led the redesign and development of strategic sections of the website (MCAC, Formaci\xF3n, Choc\xF3\u2013Dari\xE9n Corridor), applying requirements gathering, Figma prototyping, and frontend development with HTML, CSS, and JavaScript.", "Coordinated and delivered tech training sessions, designing content, assessments, and learning follow-up for the team."], check_design: "Click to check" } } }, title: "Work", featured_projects: { title: "Featured Projects", description: "Some cool stuff I\u2019ve worked on throughout the years.", video_cta: "Watch Video", code_cta: "View Code", projects: [{ title: "Optika", description: "Home security system with facial recognition for real time detection of trusted individuals and possible intruders.", award: "Best solution award winner at GEMIS awards 2022", features: ["Face detection and recognition pipeline for identity verification.", "IoT device with camera and servo-controlled door mechanism", "Web application for adding facial recognition to trusted visitors, detection logs, video streaming from Optika Camera, and trigger email alerts."] }, { title: "KarelDB", description: "Multithreaded in-memory database management system with AOF (Append-only file) persistence mechanism.", features: ["TCP Server implementation using Sockets and Threads", "Implemented basic INSERT, UPDATE, DELETE, SELECT operations, ensuring data integrity in a multithreaded environment using locks.", "Added 5 data types (int, string, datetime, boolean, array), foreign key support and CREATE database operation from a JSON database schema", "Java CLI client for managing a KarelDB instance"] }, { title: "Carpeta Ciudadana", description: "Digital Citizen Folder System for secure personal files management.", features: ["FastAPI Microservices orchestrated using Google Kubernetes Engine and Kong API Gateway", "MongoDB Databases for each microservice and Cloud Storage for file storage", "Cloud-based storage for uploading, managing, and downloading personal files", "Document transfer and requests between citizens using the system."] }], github_cta: "More projects on Github" }, client_solutions: { title: "Technological Solutions for Clients", description: "I solve business problems of your company with technology:", offerings: { lol: "lol", website: "<b>High-converting websites that turn visitors into customers</b> I design and build digital experiences that capture leads and drive sales\u2014combining seamless user experience, search engine optimization (SEO), and strategic integration with your marketing funnel to maximize every visitor's potential.", software: "<b>Custom software solutions to enable your digital transformation.</b>  I analyze your current processes, structure, and IT capabilities to develop tools that eliminate inefficiencies and automate what's slowing you down and set yourself up  for growth." }, projects: [{ description: "<p>Inspired by the vibrant colors of the brand and their chivas I designed and developed TuryChivas website to showcase their offering and streamline customer inquiry resolution and booking.</p> <ul><li>SEO Optimization</li><li>Analytics dashboard</li><li>Content management system</li></ul>" }] } }, contact: { title: "Let\u2019s get in touch", subtitle: "Currently open for software engineering roles or related", message: "Let\u2019s build together." } });
    }, 74324, (e) => {
      e.v({ HomePage: { title: "Bienvenido a Daniel Palacios", description: "Portafolio y Sitio Personal" }, Metadata: { title: "Daniel Palacios | Ingeniero de Software Full-Stack y Dise\xF1ador UX/UI", description: "Daniel Palacios es un ingeniero full-stack biling\xFCe que crea sistemas r\xE1pidos y escalables, desde UX hasta producci\xF3n. Ha entregado impacto medible (tiempos de carga 50% m\xE1s r\xE1pidos, reducci\xF3n de tiempos de entrega de 6 a 3 meses) construyendo a trav\xE9s de frontend, backend y flujos de trabajo modernos.", keywords: "Daniel Palacios, Ingeniero Full-Stack, Ingeniero de Software, Dise\xF1ador UX/UI, React, Next.js, Portafolio, Desarrollo Web, Frontend, Backend" }, Navigation: { home: "Inicio", work: "Trabajo", about: "Sobre m\xED", contact: "Contacto" }, Hero: { name: "<daniel>Daniel</daniel> <ricardo>Ricardo</ricardo> Palacios Diego", daniel_caption: "Mi abuelo Daniel es conocido por su carisma, amor por ayudar, y siempre te saludar\xE1 con calidez y una gran sonrisa (y un consejo).", ricardo_caption: "Mi abuelo Ricardo ha sido una de las personas m\xE1s audaces y trabajadoras que he conocido en mi vida. QEPD 1952-2021\u{1F54A}\uFE0F", role: "Ingeniero de Software Full-Stack y Dise\xF1ador UX/UI", quote: "Mi prop\xF3sito es transformar el mundo a trav\xE9s de la educaci\xF3n y la tecnolog\xEDa.", bio: "Soy un ingeniero full-stack biling\xFCe que crea sistemas r\xE1pidos y escalables, desde UX hasta producci\xF3n. He entregado impacto medible (tiempos de carga 50% m\xE1s r\xE1pidos, reducci\xF3n de tiempos de entrega de 6 a 3 meses) construyendo a trav\xE9s de frontend, backend y flujos de trabajo modernos. Soy conocido por mi responsabilidad, comunicaci\xF3n clara, liderazgo y resoluci\xF3n de problemas en dominios complejos, siempre aspirando a la excelencia. \n\n Apasionado por la creaci\xF3n de tecnolog\xEDa innovadora y disruptiva, y la intersecci\xF3n entre interacci\xF3n Humano-Computador (HCI), realidad virtual y aumentada e IA aplicada.", downloadCv: "Descargar CV", workTogether: "Pong\xE1monos en contacto" }, Footer: { rights: "Todos los derechos reservados" }, TechStack: { title: "Tech Stack", design: "Dise\xF1o", "web-ui": "Interfaces Web", backend: "Backend", data: "Datos", infrastructure_tools: "Infraestructura y Herramientas" }, Education: { title: "Educaci\xF3n", eafit: { title: "Pregrado en Ingenier\xEDa de Sistemas con \xC9nfasis en Desarrollo de Software", scholarship: "Beneficiario de la beca de financiaci\xF3n completa Generaci\xF3n E por desempe\xF1o sobresaliente en pruebas de estado", optika: "Proyecto ganador de premio: <optika>Optika</optika>", representative: "Representante estudiantil de Ingenier\xEDa de Sistemas", afroeafit: "Fundador del colectivo afro de EAFIT, AFROEAFIT", gpa: "Promedio 4.4/5" }, certs: { mckinsey: { title: "McKinsey & Company", description: "Comunicaci\xF3n para el impacto, Resoluci\xF3n estructurada de problemas, Adaptabilidad y resiliencia y m\xE1s." }, alberta: { title: "Universidad de Alberta", description: "Patrones de dise\xF1o, SOA, Diagramas arquitect\xF3nicos y Trade-offs" }, learnquest: { title: "LearnQuest", description: "Desarrollo Backend con Spring Boot" } }, readings: { content: "La mayor parte de mi aprendizaje se realiza leyendo, lo que me permite tener una relaci\xF3n m\xE1s profunda con la informaci\xF3n que intento comprender. Para libros t\xE9cnicos suelo recurrir a O'Reilly Media.", cta: "Aqu\xED hay una lista de libros que he estudiado y a los que constantemente regreso.", imageCaption: "Para mi aprendizaje continuo elijo un libro t\xE9cnico y uno no t\xE9cnico para estudiar, a veces elijo un paper/art\xEDculo de inter\xE9s para leer." } }, Work: { job_experience: { swipe_sign: "Desliza para explorar la l\xEDnea de tiempo", title: "Experiencia Laboral", experiences: { eafit: { title: "EAFIT", role: "Monitor Acad\xE9mico de Proyecto integrador I", date_range: "Jun 2024 - Ene 2023", activities: ["Asesor\xE9 a m\xE1s de 200 estudiantes en desarrollo full stack"] }, cadena: { title: "Cadena", role: "Practicante de Tecnolog\xEDa", date_range: "Dic 2024 - Jun 2024", activities: ["Desarroll\xE9 una herramienta no-code para construir plantillas HTML y gr\xE1ficos din\xE1micos usando React, Redux y .NET, reduciendo el tiempo de desarrollo de plantillas.", "Integr\xE9 un gestor de variables para insertar variables en las plantillas, facilitando la generaci\xF3n autom\xE1tica de m\xFAltiples p\xE1ginas HTML con distintos conjuntos de datos.", "Optimic\xE9 llamadas API de backend y frontend, mejorando los tiempos de carga de plantillas en un 50%.", "Reduje la duraci\xF3n del proyecto de 6 a 3 meses"] }, cocomasur: { date_range: "Dic 2025 - Sep 2025", title: "Cocomasur", role: "Ingeniero de Software", activities: ["Lider\xE9 el redise\xF1o y desarrollo de secciones estrat\xE9gicas del sitio web (MCAC, Formaci\xF3n, Corredor Choc\xF3\u2013Dari\xE9n), aplicando levantamiento de requerimientos, prototipado en Figma y desarrollo frontend con HTML, CSS y JavaScript.", "Coordin\xE9 e impart\xED sesiones de capacitaci\xF3n t\xE9cnica, dise\xF1ando contenido, evaluaciones y seguimiento del aprendizaje para el equipo."], check_design: "Clic para ver" } } }, title: "Trabajo", featured_projects: { title: "Proyectos Destacados", description: "Algunas cosas interesantes en las que he trabajado a lo largo de los a\xF1os.", video_cta: "Ver Video", code_cta: "Ver C\xF3digo", projects: [{ title: "Optika", description: "Sistema de seguridad para el hogar con reconocimiento facial para la detecci\xF3n en tiempo real de personas de confianza y posibles intrusos.", award: "Ganador del premio a la mejor soluci\xF3n en los premios GEMIS 2022", features: ["Pipeline de detecci\xF3n y reconocimiento facial para la verificaci\xF3n de identidad.", "Dispositivo IoT con c\xE1mara y mecanismo de puerta controlado por servomotor.", "Aplicaci\xF3n web para registrar visitantes de confianza, consultar historiales de detecci\xF3n, ver transmisi\xF3n de video de la c\xE1mara Optika y activar alertas por correo electr\xF3nico."], video_cta: "Ver Video" }, { title: "KarelDB", description: "Sistema de gesti\xF3n de bases de datos en memoria multihilo con mecanismo de persistencia AOF (Append-only file).", features: ["Implementaci\xF3n de servidor TCP usando Sockets e Hilos", "Implementaci\xF3n de operaciones b\xE1sicas INSERT, UPDATE, DELETE, SELECT, asegurando la integridad de datos en un entorno multihilo usando bloqueos (locks).", "Adici\xF3n de 5 tipos de datos (int, string, datetime, boolean, array), soporte de claves for\xE1neas y operaci\xF3n CREATE database desde un esquema de base de datos JSON", "Cliente CLI en Java para gestionar una instancia de KarelDB"], video_cta: "Ver C\xF3digo" }, { title: "Carpeta Ciudadana", description: "Sistema de Carpeta Ciudadana Digital para la gesti\xF3n segura de archivos personales.", features: ["Microservicios FastAPI orquestados usando Google Kubernetes Engine y Kong API Gateway", "Bases de datos MongoDB para cada microservicio y Cloud Storage para almacenamiento de archivos", "Almacenamiento basado en la nube para subir, gestionar y descargar archivos personales", "Transferencia de documentos y solicitudes entre ciudadanos usando el sistema."], video_cta: "Ver C\xF3digo" }], github_cta: "M\xE1s proyectos en Github" }, client_solutions: { title: "Soluciones Tecnol\xF3gicas para Clientes", description: "Resuelvo problemas de negocio de tu empresa con tecnolog\xEDa:", offerings: { lol: "lol", website: "<b>Sitios web de alta conversi\xF3n que convierten visitantes en clientes</b> Dise\xF1o y construyo experiencias digitales que capturan leads e impulsan ventas\u2014combinando una experiencia de usuario fluida, optimizaci\xF3n para motores de b\xFAsqueda (SEO) e integraci\xF3n estrat\xE9gica con tu embudo de marketing para maximizar el potencial de cada visitante.", software: "<b>Soluciones de software personalizadas para habilitar tu transformaci\xF3n digital.</b> Analizo tus procesos actuales, estructura y capacidades de TI para desarrollar herramientas que eliminen ineficiencias, automaticen lo que te ralentiza y te preparen para el crecimiento." }, projects: [{ description: "<p>Inspirado en los colores vibrantes de la marca y sus chivas, dise\xF1\xE9 y desarroll\xE9 el sitio web de TuryChivas para mostrar su oferta y agilizar la resoluci\xF3n de consultas y reservas de clientes.</p> <ul><li>Optimizaci\xF3n SEO</li><li>Panel de an\xE1lisis</li><li>Sistema de gesti\xF3n de contenidos</li></ul>" }] } }, contact: { title: "Pong\xE1monos en contacto", subtitle: "Actualmente disponible para roles de ingenier\xEDa de software o relacionados", message: "Construyamos juntos." } });
    }]);
  }
});
  ...
  ".next/server/edge/chunks/[root-of-the-server]__a0bafeed._.js"() {
    ...
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__a0bafeed._.js", 28042, (e, t, r) => {
      ...
      (() => {
        "use strict";
        let r2, n, i, a, o;
        var s, l, u, c, d, h, f, p, _, g, y, m, v, b, w, E, S = { 491: (e2, t2, r3) => {
        ...
        } }), l = R(780), Object.defineProperty(C, "createContextKey", { enumerable: true, get: function() {
          return l.createContextKey;
        } }), Object.defineProperty(C, "ROOT_CONTEXT", { enumerable: true, get: function() {
          return l.ROOT_CONTEXT;
        } }), u = R(972), Object.defineProperty(C, "DiagConsoleLogger", { enumerable: true, get: function() {
        ...
        !function(n2, i2) {
          ...
          var a2 = "function", o = "undefined", s = "object", l = "string", u = "major", c = "model", d = "name", h = "type", f = "vendor", p = "version", _ = "architecture", g = "console", y = "mobile", m = "tablet", v = "smarttv", b = "wearable", w = "embedded", E = "Amazon", S = "Apple", T = "ASUS", R = "BlackBerry", C = "Browser", P = "Chrome", O = "Firefox", A = "Google", x = "Huawei", N = "Microsoft", I = "Motorola", L = "Opera", M = "Samsung", k = "Sharp", B = "Sony", D = "Xiaomi", H = "Zebra", U = "Facebook", j = "Chromium OS", $ = "Mac OS", G = function(e2, t3) {
            ...
            return this.getBrowser = function() {
              ...
              var e3 = {};
              return e3[d] = void 0, e3[p] = void 0, W.call(e3, i3, v2.os), b2 && !e3[d] && g2 && "Unknown" != g2.platform && (e3[d] = g2.platform.replace(/chrome os/i, j).replace(/macos/i, $)), e3;
          ...
          if (Z.VERSION = "1.0.35", Z.BROWSER = q([d, p, u]), Z.CPU = q([_]), Z.DEVICE = q([c, f, h, g, y, v, m, b, w]), Z.ENGINE = Z.OS = q([d, p]), typeof r2 !== o) t2.exports && (r2 = t2.exports = Z), r2.UAParser = Z;
      ...
      function R(e2, t2, r2) {
        ...
        return !function e3(t3, r3, n3, u3, c2) {
          ...
          g2 = 0;
          var y2 = "" === u3 ? "." : u3 + ":";
          if (a(t3)) for (var v2 = 0; v2 < t3.length; v2++) p2 = y2 + T(u3 = t3[v2], v2), g2 += e3(u3, r3, n3, p2, c2);
          else if ("function" == typeof (v2 = null === (f2 = t3) || "object" != typeof f2 ? null : "function" == typeof (f2 = m && f2[m] || f2["@@iterator"]) ? f2 : null)) for (t3 = v2.call(t3), v2 = 0; !(u3 = t3.next()).done; ) p2 = y2 + T(u3 = u3.value, v2++), g2 += e3(u3, r3, n3, p2, c2);
          else if ("object" === p2) {
      ...
      e.s(["isHangingPromiseRejectionError", () => _, "makeDevtoolsIOAwarePromise", () => w, "makeHangingPromise", () => v], 51564), e.s(["isBailoutToCSRError", () => E], 81828);
      ...
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), e.s(["abortAndThrowOnSynchronousRequestDataAccess", () => C, "delayUntilRuntimeStage", () => M, "isDynamicPostpone", () => A, "isPrerenderInterruptedError", () => L, "postponeWithTracking", () => P, "throwToInterruptStaticGeneration", () => T, "trackDynamicDataInDynamicRender", () => R], 63072);
      ...
      var m = Symbol.asyncIterator, v = Symbol.for("react.optimistic_key");
      function b(e10) {
        setTimeout(function() {
          throw e10;
        });
      ...
      var K = "function" == typeof AsyncLocalStorage, W = K ? new AsyncLocalStorage() : null, X = Symbol.for("react.temporary.reference"), z = { get: function(e10, t2) {
        switch (t2) {
          case "$$typeof":
            return e10.$$typeof;
          case "name":
      ...
      function eS(e10, t2, r2) {
        ...
        return r2.then(function(t3) {
          ...
          0 === n2.status && (eX(e10, n2, t3), e5(e10));
        }), n2.id;
      }
      ...
      function eP(e10, t2, r2, n2, i2) {
        ...
        if (t2.thenableState = null, et = 0, er = a2, i2 = n2(i2, void 0), 12 === e10.status) throw "object" == typeof i2 && null !== i2 && "function" == typeof i2.then && i2.$$typeof !== x && i2.then(eC, eC), null;
        return i2 = function(e11, t3, r3, n3) {
          ...
          if ("function" == typeof n3.then) {
            ...
            return { $$typeof: f, _payload: n3, _init: eR };
          }
          var i3 = y(n3);
        ...
        }(e10, 0, 0, i2), n2 = t2.keyPath, a2 = t2.implicitSlot, null !== r2 ? t2.keyPath = r2 === v || n2 === v ? v : null === n2 ? r2 : n2 + "," + r2 : null === n2 && (t2.implicitSlot = true), e10 = ej(e10, t2, ez, "", i2), t2.keyPath = n2, t2.implicitSlot = a2, e10;
      }
      ...
      function ej(e10, t2, r2, n2, i2) {
        ...
        if ("object" == typeof i2) {
          switch (i2.$$typeof) {
            case o:
              ...
              return r2 = (n2 = i2.props).ref, "object" == typeof (e10 = function e11(t3, r3, n3, i3, a2, l3) {
                ...
                if ("function" == typeof n3 && n3.$$typeof !== x && n3.$$typeof !== X) return eP(t3, r3, i3, n3, l3);
                if (n3 === s && null === i3) return n3 = r3.implicitSlot, null === r3.keyPath && (r3.implicitSlot = true), l3 = ej(t3, r3, ez, "", l3.children), r3.implicitSlot = n3, l3;
          ...
          if ("function" == typeof Blob && i2 instanceof Blob) return function(e11, t3) {
            function r3(t4) {
              0 === a2.status && (e11.cacheController.signal.removeEventListener("abort", n3), eX(e11, a2, t4), e5(e11), o2.cancel(t4).then(r3, r3));
            }
            function n3() {
              if (0 === a2.status) {
                var t4 = e11.cacheController.signal;
                t4.removeEventListener("abort", n3), t4 = t4.reason, 21 === e11.type ? (e11.abortableTasks.delete(a2), e1(a2), e2(a2, e11)) : (eX(e11, a2, t4), e5(e11)), o2.cancel(t4).then(r3, r3);
              }
            }
          ...
          if ("function" == typeof ReadableStream && i2 instanceof ReadableStream) return function(e11, t3, r3) {
            function n3(t4) {
              0 === l3.status && (e11.cacheController.signal.removeEventListener("abort", i3), eX(e11, l3, t4), e5(e11), s2.cancel(t4).then(n3, n3));
            }
            function i3() {
              if (0 === l3.status) {
                var t4 = e11.cacheController.signal;
                t4.removeEventListener("abort", i3), t4 = t4.reason, 21 === e11.type ? (e11.abortableTasks.delete(l3), e1(l3), e2(l3, e11)) : (eX(e11, l3, t4), e5(e11)), s2.cancel(t4).then(n3, n3);
              }
            }
          ...
          if ("function" == typeof (l2 = i2[m])) return null !== t2.keyPath ? (e10 = [o, s, t2.keyPath, { children: i2 }], e10 = t2.implicitSlot ? [e10] : e10) : (n2 = l2.call(i2), e10 = function(e11, t3, r3, n3) {
            function i3(t4) {
              0 === o2.status && (e11.cacheController.signal.removeEventListener("abort", a2), eX(e11, o2, t4), e5(e11), "function" == typeof n3.throw && n3.throw(t4).then(i3, i3));
            }
            function a2() {
              if (0 === o2.status) {
                var t4 = e11.cacheController.signal;
                ...
                var r4 = t4.reason;
                21 === e11.type ? (e11.abortableTasks.delete(o2), e1(o2), e2(o2, e11)) : (eX(e11, o2, t4.reason), e5(e11)), "function" == typeof n3.throw && n3.throw(r4).then(i3, i3);
              }
            }
            r3 = r3 === n3;
      ...
      function e3(e10) {
        ...
        if (null !== t2) {
          ...
          try {
            for (var r2 = e10.completedImportChunks, n2 = 0; n2 < r2.length; n2++) e10.pendingChunks--, R(t2, r2[n2]);
            r2.splice(0, n2);
            var i2 = e10.completedHintChunks;
            for (n2 = 0; n2 < i2.length; n2++) R(t2, i2[n2]);
            i2.splice(0, n2);
            var a2 = e10.completedRegularChunks;
            for (n2 = 0; n2 < a2.length; n2++) e10.pendingChunks--, R(t2, a2[n2]);
            a2.splice(0, n2);
            var o2 = e10.completedErrorChunks;
            for (n2 = 0; n2 < o2.length; n2++) e10.pendingChunks--, R(t2, o2[n2]);
            o2.splice(0, n2);
          } finally {
      ...
      function td(e10, t2, r2) {
        for (var n2 = 0; n2 < t2.length; n2++) {
          var i2 = t2[n2];
          "function" == typeof i2 ? i2(r2) : tR(e10, i2.handler, r2);
        }
      }
      ...
      function ty(e10, t2, r2, n2) {
        function i2(t3) {
          var r3 = s2.reason;
          s2.status = "rejected", s2.value = null, s2.reason = t3, null !== r3 && td(e10, r3, t3), tR(e10, u2, t3);
        }
        var a2 = t2.id;
        if ("string" != typeof a2 || "then" === n2) return null;
        var o2 = t2.$$promise;
        if (void 0 !== o2) return "fulfilled" === o2.status ? (o2 = o2.value, "__proto__" === n2 ? null : r2[n2] = o2) : (tv ? (a2 = tv, a2.deps++) : a2 = tv = { chunk: null, value: null, reason: null, deps: 1, errored: false }, o2.then(tT.bind(null, e10, a2, r2, n2), tR.bind(null, e10, a2)), null);
            ...
            if ("string" == typeof i3) return function(e12, t4, r4, n4, i4, a4) {
              if ("$" === n4[0]) {
                switch (n4[1]) {
                  ...
                  case "h":
                    return tC(e12, a4 = n4.slice(2), t4, r4, null, ty);
                  case "T":
                    var o4, s4, l3;
                    ...
                    }, { $$typeof: { value: X } }), z), o4.set(l3, s4), l3;
                  case "Q":
                    return tC(e12, a4 = n4.slice(2), t4, r4, null, tP);
                  case "W":
                    return tC(e12, a4 = n4.slice(2), t4, r4, null, tO);
                  case "K":
                    ...
                    return r4;
                  case "i":
                    return tC(e12, a4 = n4.slice(2), t4, r4, null, tA);
                  case "I":
                    return 1 / 0;
                  case "-":
                    return "$-0" === n4 ? -0 : -1 / 0;
                ...
                return tC(e12, n4 = n4.slice(1), t4, r4, a4, tx);
              }
  ...
  `);
      ...
      class M {
        constructor(e10, t10, r10) {
          let n2, i2;
          "object" == typeof t10 && "pathname" in t10 || "string" == typeof t10 ? (n2 = t10, i2 = r10 || {}) : i2 = r10 || t10 || {}, this[L] = { url: I(e10, n2 ?? i2.base), options: i2, basePath: "" }, this.analyze();
        }
        analyze() {
          ...
          this[L].domainLocale = this[L].options.i18nProvider ? this[L].options.i18nProvider.detectDomainLocale(o2) : function(e11, t11, r11) {
            if (e11) {
          ...
          let s2 = (null == (r10 = this[L].domainLocale) ? void 0 : r10.defaultLocale) || (null == (i2 = this[L].options.nextConfig) || null == (n2 = i2.i18n) ? void 0 : n2.defaultLocale);
        ...
        formatPathname() {
          ...
          }((e10 = { basePath: this[L].basePath, buildId: this[L].buildId, defaultLocale: this[L].options.forceLocale ? void 0 : this[L].defaultLocale, locale: this[L].locale, pathname: this[L].url.pathname, trailingSlash: this[L].trailingSlash }).pathname, e10.locale, e10.buildId ? void 0 : e10.defaultLocale, e10.ignorePrefix), (e10.buildId || !e10.trailingSlash) && (t10 = T(t10)), e10.buildId && (t10 = P(C(t10, `/_next/data/${e10.buildId}`), "/" === e10.pathname ? "index.json" : ".json")), t10 = C(t10, e10.basePath), !e10.buildId && e10.trailingSlash ? t10.endsWith("/") ? t10 : P(t10, "/") : T(t10);
        }
        formatSearch() {
      ...
      var k, B, D, H, U, j, $, G, q, F, V, K, W, X, z, Y, Z, J, Q, ee = e.i(28042);
      ...
      class es extends Response {
        constructor(e10, t10 = {}) {
          ...
          this[ei] = { cookies: n2, url: t10.url ? new M(t10.url, { headers: y(r10), nextConfig: t10.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
        ...
        static redirect(e10, t10) {
          ...
          return i2.set("Location", m(e10)), new es(null, { ...n2, headers: i2, status: r10 });
        }
        static rewrite(e10, t10) {
          let r10 = new Headers(null == t10 ? void 0 : t10.headers);
          return r10.set("x-middleware-rewrite", m(e10)), eo(t10, r10), new es(null, { ...t10, headers: r10 });
        }
        static next(e10) {
      ...
      var em = ((k = em || {}).handleRequest = "BaseServer.handleRequest", k.run = "BaseServer.run", k.pipe = "BaseServer.pipe", k.getStaticHTML = "BaseServer.getStaticHTML", k.render = "BaseServer.render", k.renderToResponseWithComponents = "BaseServer.renderToResponseWithComponents", k.renderToResponse = "BaseServer.renderToResponse", k.renderToHTML = "BaseServer.renderToHTML", k.renderError = "BaseServer.renderError", k.renderErrorToResponse = "BaseServer.renderErrorToResponse", k.renderErrorToHTML = "BaseServer.renderErrorToHTML", k.render404 = "BaseServer.render404", k), ev = ((B = ev || {}).loadDefaultErrorComponents = "LoadComponents.loadDefaultErrorComponents", B.loadComponents = "LoadComponents.loadComponents", B), eb = ((D = eb || {}).getRequestHandler = "NextServer.getRequestHandler", D.getRequestHandlerWithMetadata = "NextServer.getRequestHandlerWithMetadata", D.getServer = "NextServer.getServer", D.getServerRequestHandler = "NextServer.getServerRequestHandler", D.createServer = "createServer.createServer", D), ew = ((H = ew || {}).compression = "NextNodeServer.compression", H.getBuildId = "NextNodeServer.getBuildId", H.createComponentTree = "NextNodeServer.createComponentTree", H.clientComponentLoading = "NextNodeServer.clientComponentLoading", H.getLayoutOrPageModule = "NextNodeServer.getLayoutOrPageModule", H.generateStaticRoutes = "NextNodeServer.generateStaticRoutes", H.generateFsStaticRoutes = "NextNodeServer.generateFsStaticRoutes", H.generatePublicRoutes = "NextNodeServer.generatePublicRoutes", H.generateImageRoutes = "NextNodeServer.generateImageRoutes.route", H.sendRenderResult = "NextNodeServer.sendRenderResult", H.proxyRequest = "NextNodeServer.proxyRequest", H.runApi = "NextNodeServer.runApi", H.render = "NextNodeServer.render", H.renderHTML = "NextNodeServer.renderHTML", H.imageOptimizer = "NextNodeServer.imageOptimizer", H.getPagePath = "NextNodeServer.getPagePath", H.getRoutesManifest = "NextNodeServer.getRoutesManifest", H.findPageComponents = "NextNodeServer.findPageComponents", H.getFontManifest = "NextNodeServer.getFontManifest", H.getServerComponentManifest = "NextNodeServer.getServerComponentManifest", H.getRequestHandler = "NextNodeServer.getRequestHandler", H.renderToHTML = "NextNodeServer.renderToHTML", H.renderError = "NextNodeServer.renderError", H.renderErrorToHTML = "NextNodeServer.renderErrorToHTML", H.render404 = "NextNodeServer.render404", H.startResponse = "NextNodeServer.startResponse", H.route = "route", H.onProxyReq = "onProxyReq", H.apiResolver = "apiResolver", H.internalFetch = "internalFetch", H), eE = ((U = eE || {}).startServer = "startServer.startServer", U), eS = ((j = eS || {}).getServerSideProps = "Render.getServerSideProps", j.getStaticProps = "Render.getStaticProps", j.renderToString = "Render.renderToString", j.renderDocument = "Render.renderDocument", j.createBodyResult = "Render.createBodyResult", j), eT = (($ = eT || {}).renderToString = "AppRender.renderToString", $.renderToReadableStream = "AppRender.renderToReadableStream", $.getBodyResult = "AppRender.getBodyResult", $.fetch = "AppRender.fetch", $), eR = ((G = eR || {}).executeRoute = "Router.executeRoute", G), eC = ((q = eC || {}).runHandler = "Node.runHandler", q), eP = ((F = eP || {}).runHandler = "AppRouteRouteHandlers.runHandler", F), eO = ((V = eO || {}).generateMetadata = "ResolveMetadata.generateMetadata", V.generateViewport = "ResolveMetadata.generateViewport", V), eA = ((K = eA || {}).execute = "Middleware.execute", K);
      ...
      async function td(t10) {
        ...
        let v2 = f2.searchParams.get(eu.NEXT_RSC_UNION_QUERY), b2 = new ts({ page: t10.page, input: ((c2 = (l2 = "string" == typeof f2) ? new URL(f2) : f2).searchParams.delete(eu.NEXT_RSC_UNION_QUERY), l2 ? c2.toString() : c2).toString(), init: { body: t10.request.body, headers: _2, method: t10.request.method, nextConfig: t10.request.nextConfig, signal: t10.request.signal } });
        ...
        let E2 = t10.request.waitUntil ?? (null == (r10 = null == (d2 = globalThis[ta]) ? void 0 : d2.get()) ? void 0 : r10.waitUntil), T2 = new S({ request: b2, page: t10.page, context: E2 ? { waitUntil: E2 } : void 0 });
        if ((o2 = await tu(b2, () => {
          if ("/middleware" === t10.page || "/src/middleware" === t10.page || "/proxy" === t10.page || "/src/proxy" === t10.page) {
            let e10 = T2.waitUntil.bind(T2), r11 = new tn();
            return eK().trace(eA.execute, { spanName: `middleware ${b2.method}`, attributes: { "http.target": b2.nextUrl.pathname, "http.method": b2.method } }, async () => {
              try {
                var n3, i3, a3, o3, l3, u2;
                let c3 = ti(), d3 = await to("/", b2.nextUrl, null), h3 = (l3 = b2.nextUrl, u2 = (e11) => {
                  s2 = e11;
                }, function(e11, t11, r12, n4, i4, a4, o4, s3, l4, u3, c4, d4) {
                  function h4(e12) {
                  ...
                  return { type: "request", phase: e11, implicitTags: a4, url: { pathname: n4.pathname, search: n4.search ?? "" }, rootParams: i4, get headers() {
                    ...
                    if (!f4.cookies) {
                      ...
                      ez(t11, e12), f4.cookies = ep.seal(e12);
                    }
                    return f4.cookies;
                  }, set cookies(value) {
                    f4.cookies = value;
                    ...
                    if (!f4.mutableCookies) {
                      ...
                      ez(t11, n5), f4.mutableCookies = n5;
                    }
                    ...
                    return f4.draftMode || (f4.draftMode = new eX(l4, t11, this.cookies, this.mutableCookies)), f4.draftMode;
        ...
        if (o2 && R2 && y2 && v2) {
          let e10 = new URL(R2);
          e10.searchParams.has(eu.NEXT_RSC_UNION_QUERY) || (e10.searchParams.set(eu.NEXT_RSC_UNION_QUERY, v2), o2.headers.set("x-middleware-rewrite", e10.toString()));
        }
      ...
      function tA(e10, t10, r10, n2) {
        ...
        return i2 += function(e11, t11) {
          ...
          let r11 = tb(t11), n3 = tb(e11), i3 = tS(n3).exec(r11);
          if (!i3) return;
      ...
      function tG(e10, t10, r10) {
        ...
        if (o2 && "$" === o2[0]) {
          var l2 = "!" !== o2[1], u2 = (l2 ? r10[o2.slice(1)] : r10[o2.slice(2)]).map(function(e11) {
            return tU[e11] || [e11];
          }).reduce(function(e11, t11) {
            return tD(tD([], e11, true), t11, true);
          }, []);
      ...
      function tF(e10, t10, r10) {
        for (var n2 = 0, i2 = r10.matches; n2 < i2.length; n2++) {
          var a2 = i2[n2], o2 = tG(e10, a2.desired, r10.matchVariables) && tG(t10, a2.supported, r10.matchVariables);
          if (a2.oneway || o2 || (o2 = tG(e10, a2.supported, r10.matchVariables) && tG(t10, a2.desired, r10.matchVariables)), o2) {
      ...
      function tW(e10, t10, r10) {
        let n2, i2 = new tK.default({ headers: { "accept-language": e10.get("accept-language") || void 0 } }).languages();
        try {
          ...
          n2 = function(e12, t11, r11, n3, i3, a2) {
            "lookup" === r11.localeMatcher ? s2 = function(e13, t12, r12) {
              for (var n4 = { locale: "" }, i4 = 0; i4 < t12.length; i4++) {
                var a3 = t12[i4], o3 = a3.replace(tj, ""), s3 = function(e14, t13) {
                  for (var r13 = t13; ; ) {
            ...
            }(Array.from(e12), t11, a2) : (u2 = Array.from(e12), h2 = [], f2 = t11.reduce(function(e13, t12) {
              var r12 = t12.replace(tj, "");
              return h2.push(r12), e13[r12] = t12, e13;
            }, {}), (void 0 === p2 && (p2 = 838), _2 = 1 / 0, g2 = { matchedDesiredLocale: "", distances: {} }, h2.forEach(function(e13, t12) {
              g2.distances[e13] || (g2.distances[e13] = {}), u2.forEach(function(r12) {
                var n4, i4, a3, o3, s3, l3, u3 = (n4 = new Intl.Locale(e13).maximize(), i4 = new Intl.Locale(r12).maximize(), a3 = { language: n4.language, script: n4.script || "", region: n4.region || "" }, o3 = { language: i4.language, script: i4.script || "", region: i4.region || "" }, s3 = 0, l3 = function() {
                  var e14, t13;
                  if (!Q) {
                    var r13 = null == (t13 = null == (e14 = tH["written-new"][0]) ? void 0 : e14.paradigmLocales) ? void 0 : t13._locales.split(" "), n5 = tH["written-new"].slice(1, 5);
                    Q = { matches: tH["written-new"].slice(5).map(function(e15) {
                    ...
                    }, {}), paradigmLocales: tD(tD([], r13, true), r13.map(function(e15) {
                      return new Intl.Locale(e15.replace(/_/g, "-")).maximize().toString();
                    }), true) };
                  }
                  return Q;
                }(), a3.language !== o3.language && (s3 += tF({ language: n4.language, script: "", region: "" }, { language: i4.language, script: "", region: "" }, l3)), a3.script !== o3.script && (s3 += tF({ language: n4.language, script: a3.script, region: "" }, { language: i4.language, script: a3.script, region: "" }, l3)), a3.region !== o3.region && (s3 += tF(a3, o3, l3)), s3 + 0 + 40 * t12);
                g2.distances[e13][r12] = u3, u3 < _2 && (_2 = u3, g2.matchedDesiredLocale = e13, g2.matchedSupportedLocale = r12);
              });
            ...
            var o2, s2, l2, u2, c2, d2, h2, f2, p2, _2, g2, y2, m2 = s2.locale, v2 = i3[m2], b2 = { locale: "en", dataLocale: m2 };
            l2 = s2.extension ? function(e13) {
              t$(e13 === e13.toLowerCase(), "Expected extension to be lowercase"), t$("-u-" === e13.slice(0, 3), "Expected extension to be a Unicode locale extension");
              for (var t12, r12 = [], n4 = [], i4 = e13.length, a3 = 3; a3 < i4; ) {
                var o3 = e13.indexOf("-", a3), s3 = void 0;
                s3 = -1 === o3 ? i4 - a3 : o3 - a3;
                var l3 = e13.slice(a3, a3 + s3);
                t$(s3 >= 2, "Expected a subtag to have at least 2 characters"), void 0 === t12 && 2 != s3 ? -1 === r12.indexOf(l3) && r12.push(l3) : 2 === s3 ? (t12 = { key: l3, value: "" }, void 0 === n4.find(function(e14) {
                  return e14.key === (null == t12 ? void 0 : t12.key);
                }) && n4.push(t12)) : (null == t12 ? void 0 : t12.value) === "" ? t12.value = l3 : (t$(void 0 !== t12, "Expected keyword to be defined"), t12.value += "-" + l3), a3 += s3 + 1;
              }
            ...
            for (var w2 = [], E2 = function(e13) {
              ...
              t$(Array.isArray(i4), "keyLocaleData for ".concat(e13, " must be an array"));
              var a3 = i4[0];
              t$(void 0 === a3 || "string" == typeof a3, "value must be a string or undefined");
              var s3 = void 0, u3 = l2.find(function(t13) {
                return t13.key === e13;
              });
              if (u3) {
                var c3 = u3.value;
              ...
              var d3 = r11[e13];
              t$(null == d3 || "string" == typeof d3, "optionsValue must be a string or undefined"), "string" == typeof d3 && (t12 = e13.toLowerCase(), n4 = d3.toLowerCase(), t$(void 0 !== t12, "ukey must be defined"), "" === (d3 = n4) && (d3 = "true")), d3 !== a3 && i4.indexOf(d3) > -1 && (a3 = d3, s3 = void 0), s3 && w2.push(s3), b2[e13] = a3;
            }, S2 = 0; S2 < n3.length; S2++) E2(n3[S2]);
            return w2.length > 0 && (m2 = function(e13, t12, r12) {
              t$(-1 === e13.indexOf("-u-"), "Expected locale to not have a Unicode locale extension");
              for (var n4, i4 = "-u", a3 = 0; a3 < t12.length; a3++) {
                var o3 = t12[a3];
                i4 += "-".concat(o3);
              }
              for (var s3 = 0; s3 < r12.length; s3++) {
                var l3 = r12[s3], u3 = l3.key, c3 = l3.value;
                i4 += "-".concat(u3), "" !== c3 && (i4 += "-".concat(c3));
              }
              if ("-u" === i4) return tV(e13);
              var d3 = e13.indexOf("-x-");
              return tV(-1 === d3 ? e13 + i4 : e13.slice(0, d3) + i4 + e13.slice(d3));
      ...
      function tz(e10, t10, r10, n2) {
        let i2;
        return n2 && (i2 = tI(n2, e10.locales, e10.localePrefix)?.locale), !i2 && e10.localeDetection && (i2 = tX(e10, r10)), !i2 && e10.localeDetection && (i2 = tW(t10, e10.locales, e10.defaultLocale)), i2 || (i2 = e10.defaultLocale), i2;
      }
      URLSearchParams;
      var tY = e.i(16852), tZ = e.i(75982);
      let tJ = e.r(91375).actionAsyncStorage;
      function tQ(e10, t10, r10 = tY.RedirectStatusCode.TemporaryRedirect) {
        let n2 = Object.defineProperty(Error(tZ.REDIRECT_ERROR_CODE), "__NEXT_ERROR_CODE", { value: "E394", enumerable: false, configurable: true });
        return n2.digest = `${tZ.REDIRECT_ERROR_CODE};${t10};${e10};${r10};`, n2;
      }
      function t0(e10, t10) {
        throw tQ(e10, t10 ??= tJ?.getStore()?.isAction ? tZ.RedirectType.push : tZ.RedirectType.replace, tY.RedirectStatusCode.TemporaryRedirect);
      }
      function t1(e10, t10 = tZ.RedirectType.replace) {
        throw tQ(e10, t10, tY.RedirectStatusCode.PermanentRedirect);
      }
      var t2 = e.i(68585);
      function t3() {
      ...
      t2.HTTP_ERROR_FALLBACK_ERROR_CODE, t2.HTTP_ERROR_FALLBACK_ERROR_CODE, t2.HTTP_ERROR_FALLBACK_ERROR_CODE, e.r(82748).unstable_rethrow, e.s(["unstable_isUnrecognizedActionError", () => t3], 55493), e.i(55493);
      var t4 = e.i(40049), t5 = t4["use".trim()], t9 = e.i(88586);
      function t6(e10) {
      ...
      var t8 = e.i(5920);
      function t7(e10, t10) {
        let r10 = t10 && t10.cache ? t10.cache : ri, n2 = t10 && t10.serializer ? t10.serializer : rr;
        return (t10 && t10.strategy ? t10.strategy : function(e11, t11) {
          var r11, n3;
          let i2 = 1 === e11.length ? re : rt;
      ...
      let ri = { create: function() {
        return new rn();
      } }, ra = { variadic: function(e10, t10) {
        var r10, n2;
        return r10 = t10.cache.create(), n2 = t10.serializer, rt.bind(this, e10, r10, n2);
      }, monadic: function(e10, t10) {
        var r10, n2;
        return r10 = t10.cache.create(), n2 = t10.serializer, re.bind(this, e10, r10, n2);
      } }, ro = /(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g, rs = /[\t-\r \x85\u200E\u200F\u2028\u2029]/i, rl = /^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g, ru = /^(@+)?(\+|#+)?[rs]?$/g, rc = /(\*)(0+)|(#+)(0+)|(0+)/g, rd = /^(0+)$/;
      function rh(e10) {
        let t10 = {};
        return "r" === e10[e10.length - 1] ? t10.roundingPriority = "morePrecision" : "s" === e10[e10.length - 1] && (t10.roundingPriority = "lessPrecision"), e10.replace(ru, function(e11, r10, n2) {
      ...
      let rI = !!Object.fromEntries, rL = !!String.prototype.trimStart, rM = !!String.prototype.trimEnd, rk = rI ? Object.fromEntries : function(e10) {
        ...
        return e10.replace(rA, "");
      }, rD = rM ? function(e10) {
        return e10.trimEnd();
      } : function(e10) {
        return e10.replace(rx, "");
      }, rH = RegExp("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
      class rU {
        message;
        position;
        locale;
        ...
        parseMessage(e10, t10, r10) {
          ...
          for (; !this.isEOF(); ) {
            ...
            if (123 === i2) {
              ...
              this.bump(), n2.push({ type: r_.pound, location: rN(e11, this.clonePosition()) });
            } else if (60 !== i2 || this.ignoreTag || 47 !== this.peek()) if (60 === i2 && !this.ignoreTag && rj(this.peek() || 0)) {
            ...
            else if (!r10) return this.error(rC.UNMATCHED_CLOSING_TAG, rN(this.clonePosition(), this.clonePosition()));
            else break;
          }
        ...
        parseTag(e10, t10) {
          ...
          if (this.bumpSpace(), this.bumpIf("/>")) return { val: { type: r_.literal, value: `<${n2}/>`, location: rN(r10, this.clonePosition()) }, err: null };
          if (!this.bumpIf(">")) return this.error(rC.INVALID_TAG, rN(r10, this.clonePosition()));
          {
            let i2 = this.parseMessage(e10 + 1, t10, true);
            if (i2.err) return i2;
            let a2 = i2.val, o2 = this.clonePosition();
            if (!this.bumpIf("</")) return this.error(rC.UNCLOSED_TAG, rN(r10, this.clonePosition()));
            {
              if (this.isEOF() || !rj(this.char())) return this.error(rC.INVALID_TAG, rN(o2, this.clonePosition()));
              let e11 = this.clonePosition();
              return n2 !== this.parseTagName() ? this.error(rC.UNMATCHED_CLOSING_TAG, rN(e11, this.clonePosition())) : (this.bumpSpace(), this.bumpIf(">")) ? { val: { type: r_.tag, value: n2, children: a2, location: rN(r10, this.clonePosition()) }, err: null } : this.error(rC.INVALID_TAG, rN(o2, this.clonePosition()));
            }
          }
        }
        parseTagName() {
        ...
        parseLiteral(e10, t10) {
          ...
          let i2 = rN(r10, this.clonePosition());
          return { val: { type: r_.literal, value: n2, location: i2 }, err: null };
        }
        tryParseLeftAngleBracket() {
          var e10;
          return this.isEOF() || 60 !== this.char() || !this.ignoreTag && (rj(e10 = this.peek() || 0) || 47 === e10) ? null : (this.bump(), "<");
        }
        tryParseQuote(e10) {
        ...
        parseArgument(e10, t10) {
          let r10 = this.clonePosition();
          if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(rC.EXPECT_ARGUMENT_CLOSING_BRACE, rN(r10, this.clonePosition()));
          if (125 === this.char()) return this.bump(), this.error(rC.EMPTY_ARGUMENT, rN(r10, this.clonePosition()));
          let n2 = this.parseIdentifierIfPossible().value;
          if (!n2) return this.error(rC.MALFORMED_ARGUMENT, rN(r10, this.clonePosition()));
          if (this.bumpSpace(), this.isEOF()) return this.error(rC.EXPECT_ARGUMENT_CLOSING_BRACE, rN(r10, this.clonePosition()));
          switch (this.char()) {
            case 125:
              return this.bump(), { val: { type: r_.argument, value: n2, location: rN(r10, this.clonePosition()) }, err: null };
            case 44:
              if (this.bump(), this.bumpSpace(), this.isEOF()) return this.error(rC.EXPECT_ARGUMENT_CLOSING_BRACE, rN(r10, this.clonePosition()));
              return this.parseArgumentOptions(e10, t10, n2, r10);
            default:
              return this.error(rC.MALFORMED_ARGUMENT, rN(r10, this.clonePosition()));
          }
        }
        parseIdentifierIfPossible() {
          var e10;
          let t10 = this.clonePosition(), r10 = this.offset(), n2 = (e10 = this.message, rH.lastIndex = r10, rH.exec(e10)[1] ?? ""), i2 = r10 + n2.length;
          return this.bumpTo(i2), { value: n2, location: rN(t10, this.clonePosition()) };
        }
        parseArgumentOptions(e10, t10, r10, n2) {
          ...
          switch (a2) {
            case "":
              return this.error(rC.EXPECT_ARGUMENT_TYPE, rN(i2, o2));
            case "number":
            case "date":
            case "time": {
              this.bumpSpace();
              ...
              if (this.bumpIf(",")) {
                ...
                if (r11.err) return r11;
                let n3 = rD(r11.val);
                if (0 === n3.length) return this.error(rC.EXPECT_ARGUMENT_STYLE, rN(this.clonePosition(), this.clonePosition()));
                e11 = { style: n3, styleLocation: rN(t12, this.clonePosition()) };
              }
              let t11 = this.tryParseArgumentClose(n2);
              if (t11.err) return t11;
              let i3 = rN(n2, this.clonePosition());
              if (e11 && e11.style.startsWith("::")) {
                let t12 = rB(e11.style.slice(2));
                if ("number" === a2) {
                  let n3 = this.parseNumberSkeletonFromString(t12, e11.styleLocation);
                  if (n3.err) return n3;
                  return { val: { type: r_.number, value: r10, location: i3, style: n3.val }, err: null };
                }
                {
                  let n3;
                  if (0 === t12.length) return this.error(rC.EXPECT_DATE_TIME_SKELETON, i3);
                  let o3 = t12;
                    ...
                    for (let n4 = 0; n4 < e12.length; n4++) {
                      ...
                      if ("j" === i4) {
                        ...
                        let o4 = 1 + (1 & a3), s3 = a3 < 2 ? 1 : 3 + (a3 >> 1), l2 = function(e13) {
                          ...
                          let n5 = e13.language;
                          return "root" !== n5 && (t14 = e13.maximize().region), (rO[t14 || ""] || rO[n5 || ""] || rO[`${n5}-001`] || rO["001"])[0];
                        }(t13);
                  ...
                  let s2 = { type: rg.dateTime, pattern: o3, location: e11.styleLocation, parsedOptions: this.shouldParseSkeletons ? (n3 = {}, o3.replace(ro, (e12) => {
                    let t13 = e12.length;
                    switch (e12[0]) {
                      case "G":
                  ...
                  return { val: { type: "date" === a2 ? r_.date : r_.time, value: r10, location: i3, style: s2 }, err: null };
                }
              }
              return { val: { type: "number" === a2 ? r_.number : "date" === a2 ? r_.date : r_.time, value: r10, location: i3, style: e11?.style ?? null }, err: null };
            }
            case "plural":
            case "selectordinal":
            case "select": {
              let i3 = this.clonePosition();
              if (this.bumpSpace(), !this.bumpIf(",")) return this.error(rC.EXPECT_SELECT_ARGUMENT_OPTIONS, rN(i3, { ...i3 }));
              this.bumpSpace();
              let o3 = this.parseIdentifierIfPossible(), s2 = 0;
              if ("select" !== a2 && "offset" === o3.value) {
                if (!this.bumpIf(":")) return this.error(rC.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, rN(this.clonePosition(), this.clonePosition()));
                this.bumpSpace();
                let e11 = this.tryParseDecimalInteger(rC.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE, rC.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);
              ...
              if (u2.err) return u2;
              let c2 = rN(n2, this.clonePosition());
              if ("select" === a2) return { val: { type: r_.select, value: r10, options: rk(l2.val), location: c2 }, err: null };
              return { val: { type: r_.plural, value: r10, options: rk(l2.val), offset: s2, pluralType: "plural" === a2 ? "cardinal" : "ordinal", location: c2 }, err: null };
            }
            default:
              return this.error(rC.INVALID_ARGUMENT_TYPE, rN(i2, o2));
          }
        }
        tryParseArgumentClose(e10) {
          return this.isEOF() || 125 !== this.char() ? this.error(rC.EXPECT_ARGUMENT_CLOSING_BRACE, rN(e10, this.clonePosition())) : (this.bump(), { val: true, err: null });
        }
        parseSimpleArgStyleIfPossible() {
          ...
          for (; !this.isEOF(); ) switch (this.char()) {
            case 39: {
              this.bump();
              let e11 = this.clonePosition();
              if (!this.bumpUntil("'")) return this.error(rC.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE, rN(e11, this.clonePosition()));
              this.bump();
              break;
            }
            case 123:
        ...
        parseNumberSkeletonFromString(e10, t10) {
          ...
          try {
            r10 = function(e11) {
              ...
              let t11 = e11.split(rs).filter((e12) => e12.length > 0), r11 = [];
              for (let e12 of t11) {
                let t12 = e12.split("/");
            ...
            return this.error(rC.INVALID_NUMBER_SKELETON, t10);
          }
          return { val: { type: rg.number, tokens: r10, location: t10, parsedOptions: this.shouldParseSkeletons ? function(e11) {
            let t11 = {};
            for (let r11 of e11) {
              switch (r11.stem) {
                case "percent":
                ...
                case "KK":
                  ...
                  continue;
                case "scientific":
                  t11 = { ...t11, notation: "scientific", ...r11.options.reduce((e13, t12) => ({ ...e13, ...rp(t12) }), {}) };
                  continue;
                case "engineering":
                  t11 = { ...t11, notation: "engineering", ...r11.options.reduce((e13, t12) => ({ ...e13, ...rp(t12) }), {}) };
                  continue;
                ...
                case "integer-width":
                  ...
                  r11.options[0].replace(rc, function(e13, r12, n3, i2, a2, o2) {
              ...
              if (rl.test(r11.stem)) {
                ...
                r11.stem.replace(rl, function(e14, r12, n3, i2, a2, o2) {
                ...
                "w" === e13 ? t11 = { ...t11, trailingZeroDisplay: "stripIfInteger" } : e13 && (t11 = { ...t11, ...rh(e13) });
                continue;
              }
              if (ru.test(r11.stem)) {
                t11 = { ...t11, ...rh(r11.stem) };
              ...
              let n2 = function(e13) {
                ...
                if ("E" === e13[0] && "E" === e13[1] ? (t12 = { notation: "engineering" }, e13 = e13.slice(2)) : "E" === e13[0] && (t12 = { notation: "scientific" }, e13 = e13.slice(1)), t12) {
                  ...
                  if ("+!" === r12 ? (t12.signDisplay = "always", e13 = e13.slice(2)) : "+?" === r12 && (t12.signDisplay = "exceptZero", e13 = e13.slice(2)), !rd.test(e13)) throw Error("Malformed concise eng/scientific notation");
          ...
          for (; ; ) {
            if (0 === s2.length) {
              ...
              if ("select" !== t10 && this.bumpIf("=")) {
                let t11 = this.tryParseDecimalInteger(rC.EXPECT_PLURAL_ARGUMENT_SELECTOR, rC.INVALID_PLURAL_ARGUMENT_SELECTOR);
                if (t11.err) return t11;
                l2 = rN(e11, this.clonePosition()), s2 = this.message.slice(e11.offset, this.offset());
              } else break;
            }
            if (o2.has(s2)) return this.error("select" === t10 ? rC.DUPLICATE_SELECT_ARGUMENT_SELECTOR : rC.DUPLICATE_PLURAL_ARGUMENT_SELECTOR, l2);
            "other" === s2 && (i2 = true), this.bumpSpace();
            let n3 = this.clonePosition();
            if (!this.bumpIf("{")) return this.error("select" === t10 ? rC.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT : rC.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT, rN(this.clonePosition(), this.clonePosition()));
            let u2 = this.parseMessage(e10 + 1, t10, r10);
            if (u2.err) return u2;
            let c2 = this.tryParseArgumentClose(n3);
            if (c2.err) return c2;
            a2.push([s2, { value: u2.val, location: rN(n3, this.clonePosition()) }]), o2.add(s2), this.bumpSpace(), { value: s2, location: l2 } = this.parseIdentifierIfPossible();
          }
          return 0 === a2.length ? this.error("select" === t10 ? rC.EXPECT_SELECT_ARGUMENT_SELECTOR : rC.EXPECT_PLURAL_ARGUMENT_SELECTOR, rN(this.clonePosition(), this.clonePosition())) : this.requiresOtherClause && !i2 ? this.error(rC.MISSING_OTHER_CLAUSE, rN(this.clonePosition(), this.clonePosition())) : { val: a2, err: null };
        }
        tryParseDecimalInteger(e10, t10) {
          ...
          let o2 = rN(n2, this.clonePosition());
      ...
      function r$(e10, t10 = {}) {
        let r10 = new rU(e10, t10 = { shouldParseSkeletons: true, requiresOtherClause: true, ...t10 }).parse();
        if (r10.err) {
          let e11 = SyntaxError(rC[r10.err.kind]);
          throw e11.location = r10.err.location, e11.originalMessage = r10.err.message, e11;
        }
        return t10?.captureLocation || function e11(t11) {
          t11.forEach((t12) => {
            if (delete t12.location, rw(t12) || rE(t12)) for (let r11 in t12.options) delete t12.options[r11].location, e11(t12.options[r11].value);
            else rm(t12) && rT(t12.style) || (rv(t12) || rb(t12)) && rR(t12.style) ? delete t12.style.location : rS(t12) && e11(t12.children);
          });
        }(r10.val), r10.val;
      }
      let rG = ((Y = {}).MISSING_VALUE = "MISSING_VALUE", Y.INVALID_VALUE = "INVALID_VALUE", Y.MISSING_INTL_API = "MISSING_INTL_API", Y);
      ...
      class rF extends rq {
        constructor(e10, t10, r10, n2) {
          super(`Invalid values for "${e10}": "${t10}". Options are "${Object.keys(r10).join('", "')}"`, rG.INVALID_VALUE, n2);
        }
      }
      class rV extends rq {
        constructor(e10, t10, r10) {
          super(`Value for "${e10}" must be of type ${t10}`, rG.INVALID_VALUE, r10);
        }
      }
      class rK extends rq {
        constructor(e10, t10) {
          super(`The intl string context variable "${e10}" was not provided to the string "${t10}"`, rG.MISSING_VALUE, t10);
        }
      }
      let rW = ((Z = {})[Z.literal = 0] = "literal", Z[Z.object = 1] = "object", Z);
      function rX(e10) {
      ...
      class rz {
        ...
        constructor(e10, t10 = rz.defaultLocale, r10, n2) {
          ...
          this.formats = function(e11, t11) {
            ...
            return { getNumberFormat: t7((...e12) => new Intl.NumberFormat(...e12), { cache: rX(e11.number), strategy: ra.variadic }), getDateTimeFormat: t7((...e12) => new Intl.DateTimeFormat(...e12), { cache: rX(e11.dateTime), strategy: ra.variadic }), getPluralRules: t7((...e12) => new Intl.PluralRules(...e12), { cache: rX(e11.pluralRules), strategy: ra.variadic }) };
          }(this.formatterCache);
        }
        format = (e10) => {
          let t10 = this.formatToParts(e10);
          if (1 === t10.length) return t10[0].value;
          let r10 = t10.reduce((e11, t11) => (e11.length && t11.type === rW.literal && "string" == typeof e11[e11.length - 1] ? e11[e11.length - 1] += t11.value : e11.push(t11.value), e11), []);
          return r10.length <= 1 ? r10[0] || "" : r10;
        };
        formatToParts = (e10) => function e11(t10, r10, n2, i2, a2, o2, s2) {
          if (1 === t10.length && ry(t10[0])) return [{ type: rW.literal, value: t10[0].value }];
          let l2 = [];
          for (let u2 of t10) {
            if (ry(u2)) {
              l2.push({ type: rW.literal, value: u2.value });
              continue;
            }
            if (u2.type === r_.pound) {
              "number" == typeof o2 && l2.push({ type: rW.literal, value: n2.getNumberFormat(r10).format(o2) });
              continue;
            }
            let { value: t11 } = u2;
            if (!(a2 && t11 in a2)) throw new rK(t11, s2);
            let c2 = a2[t11];
            if (u2.type === r_.argument) {
              c2 && "string" != typeof c2 && "number" != typeof c2 && "bigint" != typeof c2 || (c2 = "string" == typeof c2 || "number" == typeof c2 || "bigint" == typeof c2 ? String(c2) : ""), l2.push({ type: "string" == typeof c2 ? rW.literal : rW.object, value: c2 });
              continue;
            }
            if (rv(u2)) {
              let e12 = "string" == typeof u2.style ? i2.date[u2.style] : rR(u2.style) ? u2.style.parsedOptions : void 0;
              l2.push({ type: rW.literal, value: n2.getDateTimeFormat(r10, e12).format(c2) });
              continue;
            }
            if (rb(u2)) {
              let e12 = "string" == typeof u2.style ? i2.time[u2.style] : rR(u2.style) ? u2.style.parsedOptions : i2.time.medium;
              l2.push({ type: rW.literal, value: n2.getDateTimeFormat(r10, e12).format(c2) });
              continue;
            }
            if (rm(u2)) {
              let e12 = "string" == typeof u2.style ? i2.number[u2.style] : rT(u2.style) ? u2.style.parsedOptions : void 0;
              if (e12 && e12.scale) {
                let t12 = e12.scale || 1;
                if ("bigint" == typeof c2) {
              ...
              l2.push({ type: rW.literal, value: n2.getNumberFormat(r10, e12).format(c2) });
              continue;
            }
            if (rS(u2)) {
              let { children: t12, value: c3 } = u2, d2 = a2[c3];
              if ("function" != typeof d2) throw new rV(c3, "function", s2);
              let h2 = d2(e11(t12, r10, n2, i2, a2, o2).map((e12) => e12.value));
              Array.isArray(h2) || (h2 = [h2]), l2.push(...h2.map((e12) => ({ type: "string" == typeof e12 ? rW.literal : rW.object, value: e12 })));
            }
            if (rw(u2)) {
              let t12 = c2, o3 = (Object.prototype.hasOwnProperty.call(u2.options, t12) ? u2.options[t12] : void 0) || u2.options.other;
              if (!o3) throw new rF(u2.value, c2, Object.keys(u2.options), s2);
            ...
            if (rE(u2)) {
              ...
              if (!o3) {
                if (!Intl.PluralRules) throw new rq(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`, rG.MISSING_INTL_API, s2);
          ...
          return l2.length < 2 ? l2 : l2.reduce((e12, t11) => {
            ...
            return r11 && r11.type === rW.literal && t11.type === rW.literal ? r11.value += t11.value : e12.push(t11), e12;
          }, []);
      ...
      var rY = ((J = rY || {}).MISSING_MESSAGE = "MISSING_MESSAGE", J.MISSING_FORMAT = "MISSING_FORMAT", J.ENVIRONMENT_FALLBACK = "ENVIRONMENT_FALLBACK", J.INSUFFICIENT_PATH = "INSUFFICIENT_PATH", J.INVALID_MESSAGE = "INVALID_MESSAGE", J.INVALID_KEY = "INVALID_KEY", J.FORMATTING_ERROR = "FORMATTING_ERROR", J);
      function rZ(e10, t10) {
        var r10, n2;
        return r10 = (...t11) => new e10(...t11), n2 = t10, t7(r10, { cache: { create: () => ({ get: (e11) => n2[e11], set(e11, t11) {
          n2[e11] = t11;
      ...
      let r0 = { current: null }, r1 = "function" == typeof t4.cache ? t4.cache : (e10) => e10, r2 = console.warn;
      function r3(e10) {
        return function(...t10) {
          r2(e10(...t10));
        };
      ...
      }), /* @__PURE__ */ new WeakMap(), r3(function(e10, t10) {
      ...
      var eh = eh, eZ = eZ;
      let r4 = /* @__PURE__ */ new WeakMap();
      function r5(e10) {
        let t10 = r4.get(e10);
        if (t10) return t10;
        let r10 = Promise.resolve(e10);
        return r4.set(e10, r10), r10;
      }
      r3(function(e10, t10) {
        let r10 = e10 ? `Route "${e10}" ` : "This route ";
      ...
      var eh = eh, eZ = eZ;
      e.i(18368), /* @__PURE__ */ new WeakMap(), r3(function(e10, t10) {
        let r10 = e10 ? `Route "${e10}" ` : "This route ";
      ...
      let r9 = (0, t4.cache)(function() {
        return { locale: void 0 };
      }), r6 = (0, t4.cache)(async function() {
        let e10 = function e11() {
          ...
          if (r10) {
            ...
            if (r10.forceStatic) return r5(ed.seal(new Headers({})));
            ...
            if (n2) switch (n2.type) {
              ...
              case "prerender-runtime":
                return (0, th.delayUntilRuntimeStage)(n2, r5(n2.headers));
              case "private-cache":
                return r5(n2.headers);
              case "request":
                return (0, th.trackDynamicDataInDynamicRender)(n2), r5(n2.headers);
            }
          }
          (0, eY.throwForMissingRequestStore)(t10);
        }();
        return tO(e10) ? await e10 : e10;
      }), r8 = (0, t4.cache)(async function() {
        let e10;
        try {
          e10 = (await r6()).get(tg) || void 0;
        } catch (e11) {
      ...
      async function r7() {
        return r9().locale || await r8();
      }
      let ne = async ({ requestLocale: t10 }) => {
        let r10 = await t10;
        return r10 && ns.locales.includes(r10) || (r10 = ns.defaultLocale), { locale: r10, messages: (await e.f({ "../messages/en.json": { id: () => 50929, module: () => Promise.resolve().then(() => e.i(50929)) }, "../messages/es.json": { id: () => 74324, module: () => Promise.resolve().then(() => e.i(74324)) } }).import(`../messages/${r10}.json`)).default };
      }, nt = (0, t4.cache)(function() {
        return Intl.DateTimeFormat().resolvedOptions().timeZone;
      }), nr = (0, t4.cache)(async function(e10, t10) {
        let r10 = e10({ locale: t10, get requestLocale() {
          return t10 ? Promise.resolve(t10) : r7();
        } });
        if (tO(r10) && (r10 = await r10), !r10.locale) throw Error("No locale was returned from `getRequestConfig`.\n\nSee https://next-intl.dev/docs/usage/configuration#i18n-request");
        return r10;
      }), nn = (0, t4.cache)(function(e10) {
        return { getDateTimeFormat: rZ(Intl.DateTimeFormat, e10.dateTime), getNumberFormat: rZ(Intl.NumberFormat, e10.number), getPluralRules: rZ(Intl.PluralRules, e10.pluralRules), getRelativeTimeFormat: rZ(Intl.RelativeTimeFormat, e10.relativeTime), getListFormat: rZ(Intl.ListFormat, e10.list), getDisplayNames: rZ(Intl.DisplayNames, e10.displayNames) };
      }), ni = (0, t4.cache)(function() {
        return { dateTime: {}, number: {}, message: {}, relativeTime: {}, pluralRules: {}, list: {}, displayNames: {} };
      }), na = (0, t4.cache)(async function(e10) {
        let t10 = await nr(ne, e10);
        return { ...function({ formats: e11, getMessageFallback: t11, messages: r10, onError: n2, ...i2 }) {
          return { ...i2, formats: e11 || void 0, messages: r10 || void 0, onError: n2 || rQ, getMessageFallback: t11 || rJ };
        }(t10), _formatters: nn(ni()), timeZone: t10.timeZone || nt() };
      });
      async function no() {
        return (await na()).locale;
      }
      let ns = { locales: ["en", "es"], defaultLocale: "en" }, { Link: nl, redirect: nu, usePathname: nc, useRouter: nd, getPathname: nh } = function(e10) {
        let { config: t10, ...r10 } = function(e11, t11) {
          let r11 = t_(t11 || {}), n3 = r11.pathnames, i2 = (0, t4.forwardRef)(function({ href: t12, locale: i3, ...o3 }, s2) {
            let l2, u2;
            "object" == typeof t12 ? (l2 = t12.pathname, u2 = t12.params) : l2 = t12;
            let c2 = ty(t12), d2 = e11(), h2 = tO(d2) ? t5(d2) : d2, f2 = c2 ? a2({ locale: i3 || h2, href: null == n3 ? l2 : { pathname: l2, params: u2 }, forcePrefix: null != i3 || void 0 }) : l2;
            return (0, t8.jsx)(t9.default, { ref: s2, href: "object" == typeof t12 ? { ...t12, pathname: f2 } : f2, locale: i3, localeCookie: r11.localeCookie, ...o3 });
          });
          function a2(e12) {
            let t12, { forcePrefix: i3, href: a3, locale: o3 } = e12;
            return null == n3 ? "object" == typeof a3 ? (t12 = a3.pathname, a3.query && (t12 += t6(a3.query))) : t12 = a3 : t12 = function({ pathname: e13, locale: t13, params: r12, pathnames: n4, query: i4 }) {
              function a4(e14) {
                let a5, o4 = n4[e14];
                return o4 ? (a5 = tv(o4, t13, e14), r12 && Object.entries(r12).forEach(([e15, t14]) => {
                  let r13, n5;
                  Array.isArray(t14) ? (r13 = `(\\[)?\\[...${e15}\\](\\])?`, n5 = t14.map((e16) => String(e16)).join("/")) : (r13 = `\\[${e15}\\]`, n5 = String(t14)), a5 = a5.replace(RegExp(r13, "g"), n5);
                }), a5 = new URL(a5 = a5.replace(/\[\[\.\.\..+\]\]/g, ""), "http://l").pathname) : a5 = e14, a5 = tb(a5), i4 && (a5 += t6(i4)), a5;
              }
          ...
          return { config: r11, Link: i2, redirect: o2(t0), permanentRedirect: o2(t1), getPathname: a2 };
        }(no, e10);
        function n2(e11) {
          return () => {
        ...
        let a2 = i2.replace(/\\/g, "%5C").replace(/\/+/g, "/"), { domain: o2, locale: s2 } = (t10 = e10.headers, r10 = e10.cookies, n.domains ? function(e11, t11, r11, n2) {
          ...
          if (!a3) return { locale: tz(e11, t11, r11, n2) };
          if (n2) {
            let t12 = tI(n2, e11.locales, e11.localePrefix, a3)?.locale;
            if (t12) {
          ...
          if (!i3 && e11.localeDetection) {
            let t12 = tX(e11, r11);
            t12 && tk(t12, a3) && (i3 = t12);
          }
          if (!i3 && e11.localeDetection) {
            let e12 = tW(t11, a3.locales, a3.defaultLocale);
            e12 && (i3 = e12);
          }
          return i3 || (i3 = a3.defaultLocale), { locale: i3, domain: a3 };
        }(n, t10, r10, a2) : { locale: tz(n, t10, r10, a2) }), l2 = o2 ? o2.defaultLocale === s2 : s2 === n.defaultLocale, u2 = n.domains?.filter((e11) => tk(s2, e11)) || [], c2 = null != n.domains && !o2;
        function d2(t11) {
          var r11;
          let n2 = new URL(t11, e10.url);
          e10.nextUrl.basePath && (r11 = n2.pathname, n2.pathname = tb(e10.nextUrl.basePath + r11));
          let i3 = new Headers(e10.headers);
          return i3.set(tg, s2), tb(e10.nextUrl.pathname) !== tb(n2.pathname) ? es.rewrite(n2, { request: { headers: i3 } }) : es.next({ request: { headers: i3 } });
        }
        function h2(t11, r11) {
          var i3;
          let a3 = new URL(t11, e10.url);
          if (a3.pathname = tb(a3.pathname), u2.length > 0 && !r11 && o2) {
            let e11 = tB(o2, s2, u2);
            e11 && (r11 = e11.domain, e11.defaultLocale === s2 && "as-needed" === n.localePrefix.mode && (a3.pathname = tx(a3.pathname, n.locales, n.localePrefix)));
          }
          return r11 && (a3.host = r11, e10.headers.get("x-forwarded-host")) && (a3.protocol = e10.headers.get("x-forwarded-proto") ?? e10.nextUrl.protocol, a3.port = r11.split(":")[1] ?? e10.headers.get("x-forwarded-port") ?? ""), e10.nextUrl.basePath && (i3 = a3.pathname, a3.pathname = tb(e10.nextUrl.basePath + i3)), v2 = true, es.redirect(a3.toString());
        }
        let f2 = tx(a2, n.locales, n.localePrefix), p2 = tI(a2, n.locales, n.localePrefix, o2), _2 = null != p2, g2 = "never" === n.localePrefix.mode || l2 && "as-needed" === n.localePrefix.mode, y2, m2, v2, b2 = f2, w2 = n.pathnames;
        if (w2) {
          let t11;
          if ([t11, m2] = function(e11, t12, r11) {
            for (let n2 of Object.keys(e11).sort(tP)) {
              let i3 = e11[n2];
              if ("string" == typeof i3) {
                if (tw(i3, t12)) return [void 0, n2];
              } else {
                let a3 = Object.entries(i3), o3 = a3.findIndex(([e12]) => e12 === r11);
                for (let [r12] of (o3 > 0 && a3.unshift(a3.splice(o3, 1)[0]), a3)) if (tw(tv(e11[n2], r12, n2), t12)) return [r12, n2];
              }
            }
            for (let r12 of Object.keys(e11)) if (tw(r12, t12)) return [void 0, r12];
            return [void 0, void 0];
          }(w2, f2, s2), m2) {
            let r11 = w2[m2], i3 = tv(r11, s2, m2);
            if (tw(i3, f2)) b2 = tA(f2, i3, m2);
            else {
              let a3;
              a3 = t11 ? tv(r11, t11, m2) : m2;
              let o3 = g2 ? void 0 : tE(s2, n.localePrefix);
              y2 = h2(tL(tA(f2, a3, i3), o3, e10.nextUrl.search));
            }
          }
        }
        if (!y2) if ("/" !== b2 || _2) {
          let t11 = tL(b2, `/${s2}`, e10.nextUrl.search);
          if (_2) {
            let r11 = tL(f2, p2.prefix, e10.nextUrl.search);
            if ("never" === n.localePrefix.mode) y2 = h2(tL(f2, void 0, e10.nextUrl.search));
          ...
          } else y2 = g2 ? d2(t11) : h2(tL(f2, tE(s2, n.localePrefix), e10.nextUrl.search));
        } else y2 = g2 ? d2(tL(b2, `/${s2}`, e10.nextUrl.search)) : h2(tL(f2, tE(s2, n.localePrefix), e10.nextUrl.search));
        return function(e11, t11, r11, n2, i3) {
          if (!n2.localeCookie) return;
          let { name: a3, ...o3 } = n2.localeCookie, s3 = e11.cookies.has(a3);
          s3 && e11.cookies.get(a3)?.value !== r11 ? t11.cookies.set(a3, r11, { path: e11.nextUrl.basePath || void 0, ...o3 }) : s3 || tW(e11.headers, i3?.locales || n2.locales, n2.defaultLocale) === r11 || t11.cookies.set(a3, r11, { path: e11.nextUrl.basePath || void 0, ...o3 });
          ...
          function s3(e12, t12) {
            var n3;
            return e12.pathname = tb(e12.pathname), r11.nextUrl.basePath && ((e12 = new URL(e12)).pathname = (n3 = e12.pathname, tb(r11.nextUrl.basePath + n3))), `<${e12.toString()}>; rel="alternate"; hreflang="${t12}"`;
          }
          function l3(r12, i4) {
            return t11 && "object" == typeof t11 ? tA(r12, t11[n2] ?? e11, t11[i4] ?? e11) : r12;
          }
          o3 && (a3.port = "", a3.host = o3), a3.protocol = r11.headers.get("x-forwarded-proto") ?? a3.protocol, a3.pathname = tx(a3.pathname, i3.locales, i3.localePrefix);
          let u3 = tN(i3.locales, i3.localePrefix, false).flatMap(([e12, r12]) => {
            let n3;
            function o4(e13) {
              return "/" === e13 ? r12 : r12 + e13;
            }
            if (i3.domains) return i3.domains.filter((t12) => tk(e12, t12)).map((t12) => ((n3 = new URL(a3)).port = "", n3.host = t12.domain, n3.pathname = l3(a3.pathname, e12), e12 === t12.defaultLocale && "always" !== i3.localePrefix.mode || (n3.pathname = o4(n3.pathname)), s3(n3, e12)));
            {
              let r13;
              r13 = t11 && "object" == typeof t11 ? l3(a3.pathname, e12) : a3.pathname, e12 === i3.defaultLocale && "always" !== i3.localePrefix.mode || (r13 = o4(r13)), n3 = new URL(r13, a3);
            }
            return s3(n3, e12);
          });
      ...
      e.s(["config", 0, { matcher: ["/", "/(en|es)/:path*"] }, "default", 0, nf], 99446);
      var np = e.i(99446);
      e.i(96588);
      let n_ = { ...np }, ng = "/middleware", ny = n_.middleware || n_.default;
      if ("function" != typeof ny) throw new class extends Error {
        constructor(e10) {
          super(e10), this.stack = "";
        }
      }(`The Middleware file "${ng}" must export a function named \`middleware\` or a default function.`);
      e.s(["default", 0, (e10) => td({ ...e10, page: ng, handler: async (...e11) => {
        try {
          return await ny(...e11);
        } catch (i2) {
...
// .next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_66fd5060.js
var require_turbopack_node_modules_next_dist_esm_build_templates_edge_wrapper_66fd5060 = __commonJS({
  ".next/server/edge/chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_66fd5060.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/turbopack-node_modules_next_dist_esm_build_templates_edge-wrapper_66fd5060.js", { otherChunks: ["chunks/_b51dccfa._.js", "chunks/[root-of-the-server]__a0bafeed._.js"], runtimeModuleIds: [38022] }]), (() => {
      let e;
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(\\/?index|\\/?index\\\\.json))?[\\/#\\?]?$", "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/(en|es))(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\\\.json)?[\\/#\\?]?$"] }];
    require_b51dccfa();
    require_root_of_the_server_a0bafeed();
    require_turbopack_node_modules_next_dist_esm_build_templates_edge_wrapper_66fd5060();
  }
});
